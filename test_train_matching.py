...
https://www.antrimparish.com
    ...
    def test_ocr_bulletin_workflow_configuration(self) -> None:
        ...
        self.assertIn("Download mega PDFs from GitHub Pages", workflow)
        self.assertIn('curl -fL "https://frankytyrone.github.io/parish_harvester/mega_pdf/derry_mega_bulletin.pdf"', workflow)
        self.assertIn('curl -fL "https://frankytyrone.github.io/parish_harvester/mega_pdf/down_and_connor_mega_bulletin.pdf"', workflow)
        self.assertIn("-o /tmp/ocr-bulletins/derry/derry_mega_bulletin.pdf", workflow)
        self.assertIn("-o /tmp/ocr-bulletins/down_and_connor/down_and_connor_mega_bulletin.pdf", workflow)
        self.assertIn("Error: failed to download Derry mega PDF from GitHub Pages", workflow)
        self.assertIn("Error: failed to download Down and Connor mega PDF from GitHub Pages", workflow)
